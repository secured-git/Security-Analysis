.class Lcom/google/android/gms/drive/internal/zzad$zza;
.super Landroid/os/Handler;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/google/android/gms/drive/internal/zzad;
.end annotation
...
.method private constructor <init>(Landroid/os/Looper;Landroid/content/Context;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/drive/internal/zzad$zza;->mContext:Landroid/content/Context;

    return-void
.end method

.method synthetic constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/google/android/gms/drive/internal/zzad$1;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/drive/internal/zzad$zza;-><init>(Landroid/os/Looper;Landroid/content/Context;)V
...
.method private static zza(Lcom/google/android/gms/drive/events/zzl;Lcom/google/android/gms/drive/events/QueryResultEventParcelable;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/QueryResultEventParcelable;->zzqA()Lcom/google/android/gms/common/data/DataHolder;
    ...
    new-instance v0, Lcom/google/android/gms/drive/internal/zzad$zza$1;

    invoke-direct {v0, v1}, Lcom/google/android/gms/drive/internal/zzad$zza$1;-><init>(Lcom/google/android/gms/drive/MetadataBuffer;)V

    invoke-interface {p0, v0}, Lcom/google/android/gms/drive/events/zzl;->zza(Lcom/google/android/gms/drive/events/zzj;)V

    :cond_0
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/QueryResultEventParcelable;->zzqB()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/QueryResultEventParcelable;->zzqC()I

    move-result v0

    invoke-interface {p0, v0}, Lcom/google/android/gms/drive/events/zzl;->zzcs(I)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/internal/zzad$zza;->mContext:Landroid/content/Context;

    const-string v1, "EventCallback"

    const-string v2, "Don\'t know how to handle this event"

    invoke-static {v0, v1, v2}, Lcom/google/android/gms/drive/internal/zzy;->zzf(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/google/android/gms/drive/internal/zzy;->zzw(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/google/android/gms/drive/internal/zzad$zza;->zza(Lcom/google/android/gms/drive/events/zzl;Lcom/google/android/gms/drive/events/QueryResultEventParcelable;)V
...
.method public zza(Lcom/google/android/gms/drive/events/zzf;Lcom/google/android/gms/drive/events/DriveEvent;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/android/gms/drive/internal/zzad$zza;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/gms/drive/internal/zzad$zza;->sendMessage(Landroid/os/Message;)Z
