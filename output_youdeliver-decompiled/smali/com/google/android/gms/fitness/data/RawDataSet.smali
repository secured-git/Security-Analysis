...
.field public final zzaoy:I

.field public final zzaoz:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method public constructor <init>(IIILjava/util/List;Z)V
    ...
    iput p2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaow:I

    iput p3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoy:I

    iput-object p4, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoz:Ljava/util/List;

    iput-boolean p5, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzanA:Z
...
.method public constructor <init>(Lcom/google/android/gms/fitness/data/DataSet;Ljava/util/List;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoz:Ljava/util/List;

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/DataSet;->zzrv()Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzanA:Z
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaow:I
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoy:I
...
.method private zza(Lcom/google/android/gms/fitness/data/RawDataSet;)Z
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaow:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaow:I

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzanA:Z

    iget-boolean v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->zzanA:Z

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoz:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoz:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaow:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaow:I
    ...
    iget-object v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->zzaoz:Ljava/util/List;
