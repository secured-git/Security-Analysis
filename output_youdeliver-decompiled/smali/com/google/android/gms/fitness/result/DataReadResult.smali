...
.method constructor <init>(ILjava/util/List;Lcom/google/android/gms/common/api/Status;Ljava/util/List;ILjava/util/List;Ljava/util/List;)V
    ...
    iput-object p3, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzQA:Lcom/google/android/gms/common/api/Status;

    iput p5, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqH:I

    iput-object p6, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzanI:Ljava/util/List;

    iput-object p7, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqI:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzany:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzany:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqG:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqG:Ljava/util/List;
...
.method public constructor <init>(Ljava/util/List;Ljava/util/List;Lcom/google/android/gms/common/api/Status;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzany:Ljava/util/List;

    iput-object p3, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzQA:Lcom/google/android/gms/common/api/Status;

    iput-object p2, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqG:Ljava/util/List;

    const/4 v0, 0x1

    iput v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqH:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzanI:Ljava/util/List;
...
.method private zza(Lcom/google/android/gms/fitness/data/Bucket;Ljava/util/List;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqG:Ljava/util/List;
...
.method private zzc(Lcom/google/android/gms/fitness/result/DataReadResult;)Z
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzQA:Lcom/google/android/gms/common/api/Status;

    iget-object v1, p1, Lcom/google/android/gms/fitness/result/DataReadResult;->zzQA:Lcom/google/android/gms/common/api/Status;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzany:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/result/DataReadResult;->zzany:Ljava/util/List;
    ...
    iget-object v1, p1, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqG:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzQA:Lcom/google/android/gms/common/api/Status;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzany:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqG:Ljava/util/List;
...
.method zzrE()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzanI:Ljava/util/List;
...
.method public zzsB()I
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqH:I

    return v0
.end method

.method zzsC()Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v4, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzanI:Ljava/util/List;

    iget-object v5, p0, Lcom/google/android/gms/fitness/result/DataReadResult;->zzaqI:Ljava/util/List;
