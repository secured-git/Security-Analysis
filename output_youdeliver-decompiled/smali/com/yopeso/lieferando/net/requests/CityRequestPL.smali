.class public Lcom/yopeso/lieferando/net/requests/CityRequestPL;
...
.method public constructor <init>(Ljava/lang/String;Lcom/yopeso/lieferando/net/requests/base/VolleyListener;)V
    ...
    .prologue
    .local p2, "listener":Lcom/yopeso/lieferando/net/requests/base/VolleyListener;, "Lcom/yopeso/lieferando/net/requests/base/VolleyListener<Ljava/util/List<Lcom/yopeso/lieferando/model/LocationSuggestion;>;>;"
    const/4 v1, 0x0
    ...
    const-string v2, "/location/regions/%s.json"
    ...
    invoke-static {v4}, Lcom/yopeso/lieferando/net/requests/CityRequestPL;->paramsEncode(Ljava/lang/String;)Ljava/lang/String;
...
.method protected parseResponse(Lcom/android/volley/NetworkResponse;)Lcom/android/volley/Response;
    ...
    new-instance v5, Lcom/yopeso/lieferando/net/requests/CityRequestPL$1;

    invoke-direct {v5, p0}, Lcom/yopeso/lieferando/net/requests/CityRequestPL$1;-><init>(Lcom/yopeso/lieferando/net/requests/CityRequestPL;)V

    .line 35
    invoke-virtual {v5}, Lcom/yopeso/lieferando/net/requests/CityRequestPL$1;->getType()Ljava/lang/reflect/Type;
    ...
    .line 37
    .local v4, "locations":Ljava/util/List;, "Ljava/util/List<Lcom/yopeso/lieferando/model/LocationSuggestion;>;"
    ...
    .end local v4    # "locations":Ljava/util/List;, "Ljava/util/List<Lcom/yopeso/lieferando/model/LocationSuggestion;>;"
    :goto_1
    return-object v5
